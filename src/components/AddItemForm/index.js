...
export default function AddItemForm() {
  ...
  const [formOptions, setFormOptions] = useState({
    ...
    LocationId: '',
    TypeId: '',
    // item Availability (only for fish ATM)
    weather: 'any',
    season: [
      {
        id: 1,
  ...
  const handleFormSubmit = e => {
    console.log("the database will be updated with the following data:")
      ...
      <Box>
        {
          ...
          <FormControl className={classes.formControl} style={{display: 'inline-block', width: '89%'}}>
          ...
          :
          <FormControl className={classes.formControl} style={{width: '89%'}}>
